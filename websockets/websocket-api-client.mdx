---
title: "Low-Latency Spot Trading with WebsocketAPIClient"
sidebarTitle: "WS API Client"
description: "Use WebsocketAPIClient to send and await Spot order management commands over a persistent WebSocket connection, with the convenience of promise-based async/await."
---
