...
description: "Stream Kraken account data in real time — executions, balances, open positions, and fills — over authenticated WebSocket connections for Spot and Futures."
---
