...
description: "Bundle @siebly/kraken-api for browsers using webpack. The SDK uses the Web Crypto API for HMAC signing, making it compatible with modern browsers."
---
