...
description: "Best practices for running @siebly/kraken-api in production: client-side order IDs, reconnect handling, symbol conventions, credential security, and rollout strategy."
---
