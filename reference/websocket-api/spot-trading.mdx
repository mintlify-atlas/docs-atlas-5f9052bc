...
description: "Complete reference for WebsocketAPIClient Spot trading methods: submit, amend, edit, cancel, batch, and cancel-all-after over persistent WebSocket connections."
---
