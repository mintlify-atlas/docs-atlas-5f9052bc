...
description: "Complete method reference for InstitutionalClient — OTC quote management, custody vault operations, transaction history, and deposit/withdrawal for institutional accounts."
---
